...
Firefeed.prototype = {
  ...
  _onNewSparkForFeed: function(feed, loggedIn, onComplete, onOverflow) {
 ...
 */
Firefeed.prototype.onNewSpark = function(totalCount, loggedIn, onComplete, onOverflow) {
  ...
  this._onNewSparkForFeed(feed, loggedIn, onComplete, onOverflow);
};
 ...
 */
Firefeed.prototype.onNewSparkFor = function(id, count, loggedIn, onComplete, onOverflow) {
 ...
 *                                   latest set.
 */
Firefeed.prototype.onLatestSpark = function(count, loggedIn, onComplete, onOverflow) {
  this._validateCallback(onComplete, true);
  this._validateCallback(onOverflow, true);
